      ...
      <main className="container mx-auto px-6 pt-32 pb-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-900/60 p-6 rounded-2xl shadow-md flex flex-col items-center text-center">
          ...
          <div className="mt-4 flex gap-2 flex-wrap">
            <span className="px-3 py-1 bg-purple-600/70 text-sm rounded-lg">#GirlCoder</span>
            <span className="px-3 py-1 bg-blue-600/70 text-sm rounded-lg">#WomenInTech</span>
          </div>
            ...
            >
              ...
              >
                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5
                 .28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 
                 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 
                 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 
                 1.23-.15 1.85v4"></path>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <section className="bg-gray-900/60 p-6 rounded-2xl shadow-md">
            <h2 className="text-lg font-semibold text-purple-300 mb-2">About Me</h2>
            <p className="text-gray-300 leading-relaxed">
              Hi, I’m <span className="font-bold text-white">Francine (AstroCodeMir)</span>.{" "}
              I’m passionate about creating interactive and accessible web experiences.{" "}
              Currently, I’m sharpening my skills in{" "}
              <span className="text-blue-400">JavaScript</span> and{" "}
              <span className="text-pink-400">frontend development</span>.{" "}
              My goal is to build clean, functional projects that inspire and help others.
            </p>
          </section>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-400">
                <span className="flex items-center gap-1">
                  <span className="project-title ongoing"></span> Ongoing
                </span>
                <span className="flex items-center gap-1">
                  <span className="project-title completed"></span> Completed
                </span>
              </div>
            </div>
