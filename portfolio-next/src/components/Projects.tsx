  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        ...
        <div
        >
          <div className="relative p-10 rounded-xl border border-purple-500/30 outline outline-1 outline-purple-500/40 bg-gray-900/80 hover:outline-purple-500/80 hover:shadow-[0_0_25px_rgba(168,85,247,0.8)] transition-all duration-300 ease-in-out flex flex-col items-center text-center gap-4">
            ...
            <div className="relative w-80 h-40 rounded-xl overflow-hidden border border-purple-500/40 transition-all duration-300 group">
              <img
