...
// Modal
  const modalId = 'universalModal'; // Your modal's actual ID
  ...
  const inquiryStep = document.getElementById('inquiryStep');
  ...
  window.openDynamicModal = function(button) {
    modalTitle.textContent = button.getAttribute('data-title');
    desktopPreviewImg.src = button.getAttribute('data-desktop-img');
    mobilePreviewImg.src = button.getAttribute('data-mobile-img');
